...
In the results from a search, CiviCRM makes **Email - send now (to 50 or less)**
...
2.  From the search results screen, choose some or all of the contacts
    and from the **Actions** dropdown select **Email - send now (to 50 or less)**.
...
You can select the recipients for your mailing in two ways: sending to
existing Groups and sending to search results. Although the workflow
...
required to choose a Group from the Unsubscribe Group dropdown menu.
...
already unsubscribed from the Unsubscribe Group that you designate,
that contact will not be sent the mailing. If a contact unsubscribes via
the unsubscribe link in this mailing, they will be unsubscribed from
...
The Unsubscribe Group you designate collects unsubscribe information
only; it does not supply any contacts to the mailing. In other words,
contacts who are in the Unsubscribe Group but do not match your
...
to choose that as your Unsubscribe Group.
...
If you're using search results, perform your search (for example, using the
**Search > Advanced Search**) and then choose **Email - schedule/send via CiviMail** from the **Actions** dropdown.

![Civimail From Advanced Search](../img/advanced%20search%20schedule%20mass%20mailing.png)
